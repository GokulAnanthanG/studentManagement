...
<p title="Admin" id="icon"><i class="fa fa-user-secret" aria-hidden="true"></i></p>
  ...
  <a class="active" href="add_staff.php">Add Staff <i id="men5" class="fa fa-plus"></i></a>
...
<div class="col-md-1"></div>
<div class="col-md-9"> 
<p style="font-size:17px;">Admin can here Add the staff details </p>
...
<input type="text" id="name1" name="name" autocomplete="off" class="form-control">
</div>
<div class="form-group">
<label class="label" for="">Password</label>
<input type="text" id="Password1"  name="pass" autocomplete="off"  class="form-control">
</div>
<div class="form-group">
<label class="label" for="">Salary</label>
<input type="text" id="salary1"  name="sal" autocomplete="off"  class="form-control">
</div>
<div class="form-group">
<label class="label" for="">Qualification</label>
<input type="text" id="qualification1"  name="qual" autocomplete="off"  class="form-control">
</div>
<div class="form-group">
 <input type="button" id="submit" value="SUBMIT" id="btn1" class="form-control btn btn-primary"> 
</div>
</form>
</div>
</div>
