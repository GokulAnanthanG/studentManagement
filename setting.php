...
<p title="Admin" id="icon"><i class="fa fa-user-secret" aria-hidden="true"></i></p>
 ...
 <a class="active" href="setting.php"> Setting     <i id="men11" class="fa  fa-gear"></i></a>
 ...
 $spass= $_SESSION["pass"];
   ...
   if($newpass!=""&&$confirmpass!=""){
      if($newpass==$confirmpass){
          ...
          $sql="update user set pass='$newpass' where pass='$spass' AND name='$sname'";      
      if($con->query($sql)){
  ...
  $spass= $_SESSION["pass"];
   $newname=$_POST["newname"];
    if($newname!=""){
      ...
      $sql="update user set name='$newname' where pass='$spass' AND name='$sname'";      
      if($con->query($sql)){
