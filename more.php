...
<p title="Admin" id="icon"><i class="fa fa-user-secret" aria-hidden="true"></i></p>
 ...
 <a href="setting.php"> Setting     <i id="men11" class="fa  fa-gear"></i></a>
  <a class="active" href="more.php">More <i id="men10">...</i> </a>
...
<div class="col-md-9"><h1 style="font-family: Monaco;color:#0269A4">More ...
...
<div class="col-md-1"></div>
<div class="col-md-9">
 &nbsp;<h2 style="font-family:Times New Roman">&nbsp;&nbsp;Login Details</h2>
...
$sql="SELECT * FROM loginDetail order by ID DESC";
$res=$conn->query($sql);
if($res->num_rows>0){
...
echo"<center><h3 id='res'>NO DETAILS FOUND</h3></center>";
}
