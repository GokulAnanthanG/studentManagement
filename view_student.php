...
<p title="Admin" id="icon"><i class="fa fa-user-secret" aria-hidden="true"></i></p>
  ...
  <a class="active" href="view_student.php">view Student <i id="men4"  class="fa fa-eye"></i></a>
...
<div class="col-md-9"><h1 style="font-family: Monaco;color:#0269A4"> Student Detail
...
<div class="col-md-1"></div>
<div class="col-md-9"> 
<span><p style="font-size:17px;">In here you can view the Students detail</p></span>
<span    style="font-family: Times New Roman; font-size:15px; "> No Of Students </span><span class="badge">
...
<br><button id="btn" type="button"  class="btn btn-primary btn">Clear</button> <button id="btn2"   type="button"  title="List All" name="list"  class="btn btn-primary btn"> <i class="fa fa-chevron-circle-down"></i>
...
success:function(d){
  ...
  $(document).on('click','.del',function(){
    var permission=confirm("Are you sure want to delete the student data");
    if(permission){
     var del=$(this);
     var id=del.attr('sid');
     $("#id").val(id);
